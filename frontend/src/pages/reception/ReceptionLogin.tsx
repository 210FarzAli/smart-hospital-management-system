...
export default function ReceptionLogin() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Invalid front desk credentials."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gradient-to-br from-teal-950 via-teal-900 to-teal-850 p-12 text-white lg:flex xl:p-16">
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full bg-teal-800/80 px-3.5 py-1 text-xs font-semibold text-teal-200 ring-1 ring-teal-600/40 backdrop-blur">
            ...
            Hospital Front Desk & Patient Queue
          </div>

          <h1 className="text-4xl font-extrabold tracking-tight xl:text-5xl">
            First Point of Care. Seamless Patient Flow.
          </h1>

          <p className="text-base leading-relaxed text-teal-100">
            Rapid patient check-in, walk-in consultation registration with instant token slips, physical consultation fee collection, and unified search across appointments, lab tests, and pharmacy orders.
          </p>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 text-xs">
            ...
            <div className="flex items-center gap-2 text-teal-200">
              <CheckCircle className="h-4 w-4 text-emerald-400" />
              <span>Real-Time OPD Queue Tracker</span>
            </div>
            <div className="flex items-center gap-2 text-teal-200">
              <CheckCircle className="h-4 w-4 text-emerald-400" />
              <span>Physical Fee Collection Slip</span>
            </div>
            <div className="flex items-center gap-2 text-teal-200">
              <CheckCircle className="h-4 w-4 text-emerald-400" />
              <span>Unified Multi-Code Search</span>
            </div>
          </div>
        </div>

        <div className="relative z-10 flex items-center justify-between border-t border-teal-800/60 pt-6 text-xs text-teal-300">
          <span>Reception & Triage Counter</span>
        ...
        <div className="mx-auto w-full max-w-md space-y-8">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Sign in with your front-desk credentials to manage check-ins and patient queues.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <input
                  ...
                  placeholder="reception@hospital.local"
                  required
            ...
            >
              {loading ? "Authenticating..." : "Sign In to Reception Desk"}
